...
const DB = [
  ...
  // ── LATTAFA (Arap Niş) ──────────────────────────────────
  {id:98,  name:"Lattafa Khamrah",              brand:"Lattafa", gender:["unisex"],             mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik","orta"], notes:["Üzüm","Amber","Vanilya","Sandal"],            price:"₺400–₺700",  match:88, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#4a148c,#880e4f,#ffd54f)", icon:"🍇", sephoraSlug:null},
  {id:99,  name:"Lattafa Asad",                 brand:"Lattafa", gender:["erkek","unisex"],     mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Oud","Deri","Amber","Vetiver"],               price:"₺350–₺650",  match:85, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#1a0a00,#4e342e,#d4a017)", icon:"🦁", sephoraSlug:null},
  {id:100, name:"Lattafa Raghba",               brand:"Lattafa", gender:["unisex"],             mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"],        notes:["Amber","Vanilya","Sandal","Misk"],            price:"₺280–₺500",  match:82, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#e65100,#ff8f00,#ffd54f)", icon:"✨", sephoraSlug:null},
  ...
  // ── ARMAF ───────────────────────────────────────────────
  {id:113, name:"Armaf Club de Nuit Intense",   brand:"Armaf", gender:["erkek","unisex"],       mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["narenciye","odunsu"], budget:["orta"],            notes:["Ananas","Bergamot","Huş Ağacı","Misk"],      price:"₺500–₺900",  match:90, season:["tüm_sezonlar"],    ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#1a237e,#283593,#e8f5e9)", icon:"🏆", sephoraSlug:null},
