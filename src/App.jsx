...
.card-foot{display:flex;flex-direction:column;gap:10px;padding-top:16px;border-top:1.5px solid var(--sand);}
.card-foot-top{display:flex;justify-content:space-between;align-items:center;}
.card-foot-btns{display:grid;grid-template-columns:1fr 1fr;gap:8px;width:100%;}
.card-foot-btns .alt-btn{font-size:11px;padding:10px 6px;text-align:center;}
.card-foot-btns .buy-btn{font-size:12px;padding:10px 6px;}
