...
══════════════════════════════════════════════════════════ */
const DB = [
  {id:1,  name:"Miss Dior Blooming Bouquet",    brand:"Dior",              gender:["kadın","hediye"],        mood:["romantik","taze"],      occasion:["günlük","özel"],  family:["çiçeksi"],            budget:["orta"],           notes:["Şakayık","Beyaz Misk","Manolya"],           price:"₺6.500–₺9.500", match:92, season:["ilkbahar","yaz"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#f48fb1)",    icon:"🌸", sephoraSlug:"miss-dior-blooming-bouquet-P3100097"},
  {id:2,  name:"Miss Dior Eau de Parfum",       brand:"Dior",              gender:["kadın","hediye"],        mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["çiçeksi"],            budget:["premium"],        notes:["Gül","Şakayık","Sandal"],                  price:"₺9.500–₺13.500", match:93, season:["ilkbahar","sonbahar"], ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#fce4ec,#e91e63,#c2185b)",    icon:"🌹", sephoraSlug:"miss-dior-eau-de-parfum-P3100094"},
  {id:3,  name:"Chanel Chance Eau Tendre",      brand:"Chanel",            gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük","iş"],    family:["çiçeksi","narenciye"],budget:["premium"],        notes:["Greyfurt","Yasemin","Beyaz Misk"],          price:"₺9.200–₺13.800", match:90, season:["ilkbahar","yaz"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fff9c4,#fff176,#ffee58)",     icon:"✨", sephoraSlug:"chanel-chance-eau-tendre-P140004"},
  {id:4,  name:"Chanel Chance Eau Fraîche",     brand:"Chanel",            gender:["kadın"],                 mood:["taze"],                 occasion:["günlük"],         family:["narenciye","çiçeksi"],budget:["premium"],        notes:["Limon","Su Hyasintiyle","Sedir"],           price:"₺8.800–₺13.200", match:87, season:["yaz"],                 ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e0f7fa,#80deea,#26c6da)",     icon:"💧", sephoraSlug:"chanel-chance-eau-fraiche-P140005"},
  {id:5,  name:"Chanel N°5 Eau de Parfum",     brand:"Chanel",            gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["özel","gece"],    family:["çiçeksi","oryantal"], budget:["premium","lüks"], notes:["Yasemin","Iris","Sandal"],                  price:"₺10.500–₺16.500", match:95, season:["sonbahar","kış"],      ageGroup:["olgun","tüm_yaşlar"],color:"linear-gradient(160deg,#fffde7,#fff9c4,#f5c842)",    icon:"👑", sephoraSlug:"chanel-no5-eau-de-parfum-P8010"},
  {id:6,  name:"Chanel Coco Mademoiselle",      brand:"Chanel",            gender:["kadın"],                 mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["çiçeksi","oryantal"], budget:["premium","lüks"], notes:["Portakal","Gül","Patchouli"],               price:"₺10.200–₺15.800", match:94, season:["tüm_sezonlar"],        ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#efebe9,#d7ccc8,#a1887f)",     icon:"🖤", sephoraSlug:"chanel-coco-mademoiselle-P15328"},
  {id:7,  name:"Lancôme La Vie Est Belle",      brand:"Lancôme",           gender:["kadın","hediye"],        mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["oryantal","çiçeksi"], budget:["orta","premium"], notes:["Iris","Pralin","Vanilya"],                  price:"₺7.500–₺11.500", match:88, season:["sonbahar","kış"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#f3e5f5,#ce93d8,#ab47bc)",     icon:"💜", sephoraSlug:"lancome-la-vie-est-belle-P326730"},
  {id:8,  name:"Lancôme Idôle",                brand:"Lancôme",           gender:["kadın","hediye"],        mood:["taze","sofistike"],     occasion:["iş","günlük"],    family:["çiçeksi","odunsu"],   budget:["orta","premium"], notes:["Iris","Sedir","Misk"],                      price:"₺7.200–₺10.800", match:87, season:["ilkbahar","yaz"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#e91e63)",     icon:"🌷", sephoraSlug:"lancome-idole-P449887"},
  {id:9,  name:"Viktor & Rolf Flowerbomb",        brand:"Viktor & Rolf",       gender:["kadın"],                 mood:["romantik","sofistike"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["premium"],        notes:["Patchouli","Jasmin","Gül"],                 price:"₺10.500–₺15.500", match:94, season:["kış","sonbahar"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#fce4ec,#f06292,#c62828)",     icon:"💣", sephoraSlug:"viktor-rolf-flowerbomb-P204088"},
  {id:10, name:"Gucci Bloom",                  brand:"Gucci",             gender:["kadın","hediye"],        mood:["romantik","doğal"],     occasion:["günlük","özel"],  family:["çiçeksi"],            budget:["premium"],        notes:["Tuberose","Jasmin","Kumkuat"],              price:"₺8.200–₺12.500", match:91, season:["ilkbahar","yaz"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#f1f8e9,#dcedc8,#8bc34a)",     icon:"🌼", sephoraSlug:"gucci-bloom-P432631"},
  {id:11, name:"YSL Black Opium",              brand:"YSL",               gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["premium"],        notes:["Kahve","Vanilya","Beyaz Çiçek"],            price:"₺9.500–₺14.200", match:96, season:["kış","sonbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#212121,#424242,#c62828)",      icon:"☕", sephoraSlug:"ysl-black-opium-P389158"},
  {id:12, name:"YSL Mon Paris",                brand:"YSL",               gender:["kadın"],                 mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["çiçeksi","oryantal"], budget:["premium"],        notes:["Çilek","Patchouli","Beyaz Misk"],           price:"₺9.200–₺13.800", match:90, season:["sonbahar","kış"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fce4ec,#e91e63,#880e4f)",      icon:"🗼", sephoraSlug:"ysl-mon-paris-P412546"},
  {id:13, name:"YSL Libre",                    brand:"YSL",               gender:["kadın"],                 mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["çiçeksi","odunsu"],   budget:["premium"],        notes:["Lavanta","Portakal Çiçeği","Misk"],        price:"₺9.800–₺14.500", match:91, season:["tüm_sezonlar"],        ageGroup:["orta"],           color:"linear-gradient(160deg,#ede7f6,#9c27b0,#4a148c)",      icon:"💛", sephoraSlug:"ysl-libre-P447649"},
  {id:14, name:"Burberry Her",                 brand:"Burberry",          gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük","iş"],    family:["çiçeksi","narenciye"],budget:["orta"],           notes:["Kırmızı Meyve","Misk","Sedir"],             price:"₺7.200–₺10.800", match:86, season:["ilkbahar","yaz"],      ageGroup:["genç"],           color:"linear-gradient(160deg,#fce4ec,#ff80ab,#f50057)",      icon:"🍓", sephoraSlug:"burberry-her-P432856"},
  {id:15, name:"Marc Jacobs Daisy",            brand:"Marc Jacobs",       gender:["kadın","hediye"],        mood:["taze","doğal"],         occasion:["günlük"],         family:["çiçeksi"],            budget:["orta"],           notes:["Çilek","Menekşe","Sandal"],                 price:"₺5.500–₺8.500", match:84, season:["ilkbahar","yaz"],      ageGroup:["genç"],           color:"linear-gradient(160deg,#fffde7,#ffeb3b,#f9a825)",      icon:"🌻", sephoraSlug:"marc-jacobs-daisy-P203842"},
  {id:16, name:"Chloé Eau de Parfum",          brand:"Chloé",             gender:["kadın","hediye"],        mood:["romantik","taze"],      occasion:["günlük","iş"],    family:["çiçeksi"],            budget:["orta","premium"], notes:["Gül","Manolya","Sedir"],                    price:"₺8.500–₺12.800", match:89, season:["ilkbahar","yaz"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#fff9c4)",      icon:"🌹", sephoraSlug:"chloe-eau-de-parfum-P271685"},
  {id:17, name:"Paco Rabanne Olympéa",         brand:"Paco Rabanne",      gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["orta","premium"], notes:["Yeşil Mandalina","Tuzlu Vanilya","Misk"],   price:"₺7.200–₺10.800", match:90, season:["kış","sonbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e8f5e9,#a5d6a7,#2e7d32)",      icon:"⚡", sephoraSlug:"paco-rabanne-olympea-P395752"},
  {id:18, name:"Carolina Herrera Good Girl",   brand:"Carolina Herrera",  gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["premium"],        notes:["Kakao","Jasmin","Tuberose"],                price:"₺10.500–₺15.500", match:93, season:["kış","sonbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#1a237e,#311b92,#c62828)",      icon:"👠", sephoraSlug:"carolina-herrera-good-girl-P411393"},
  {id:19, name:"Givenchy Irresistible",        brand:"Givenchy",          gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük","iş"],    family:["çiçeksi"],            budget:["orta","premium"], notes:["Gül","Sedir","Vanilya"],                    price:"₺7.800–₺11.500", match:87, season:["ilkbahar","yaz"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fce4ec,#f48fb1,#e91e63)",      icon:"🌷", sephoraSlug:"givenchy-irresistible-P461754"},
  {id:20, name:"Armani Sì",                    brand:"Giorgio Armani",    gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["iş","özel"],      family:["çiçeksi","oryantal"], budget:["premium"],        notes:["Kasis","Vanilya","Patchouli"],              price:"₺9.800–₺14.500", match:91, season:["sonbahar","kış"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#efebe9,#bcaaa4,#4e342e)",      icon:"🍇", sephoraSlug:"armani-si-P337609"},
  {id:21, name:"Narciso Rodriguez For Her",    brand:"Narciso Rodriguez", gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["orta","premium"], notes:["Misk","Gül","Amber"],                       price:"₺8.500–₺12.800", match:91, season:["sonbahar","kış"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#f3e5f5,#e1bee7,#9c27b0)",      icon:"🤍", sephoraSlug:"narciso-rodriguez-for-her-P246533"},
  {id:22, name:"Parfums de Marly Delina",      brand:"Parfums de Marly",  gender:["kadın","hediye"],        mood:["romantik","taze"],      occasion:["özel","günlük"],  family:["çiçeksi"],            budget:["lüks"],           notes:["Şakayık","Lychee","Gül"],                  price:"₺18.000–₺26.000",match:96, season:["ilkbahar","yaz"],      ageGroup:["orta"],           color:"linear-gradient(160deg,#fce4ec,#f48fb1,#fff9c4)",      icon:"🌸", sephoraSlug:"parfums-de-marly-delina-P432870"},
  {id:23, name:"Kilian Good Girl Gone Bad",    brand:"Kilian Paris",      gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["lüks"],           notes:["Gül","Iris","Tuberose"],                    price:"₺21.000–₺30.000",match:94,season:["kış","sonbahar"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#880e4f,#c62828,#212121)",      icon:"🖤", sephoraSlug:"kilian-good-girl-gone-bad-P396088"},
  {id:24, name:"Guerlain Shalimar",            brand:"Guerlain",          gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["premium","lüks"], notes:["Bergamot","Vanilya","Opoponaks"],            price:"₺10.500–₺15.800", match:92, season:["kış"],                 ageGroup:["olgun"],          color:"linear-gradient(160deg,#fff8e1,#ffe082,#ff8f00)",      icon:"👑", sephoraSlug:"guerlain-shalimar-P236099"},
  {id:25, name:"Dior Sauvage",                 brand:"Dior",              gender:["erkek","unisex"],        mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["premium"],        notes:["Bergamot","Sedir","Ambroxan"],              price:"₺9.800–₺14.500", match:95, season:["yaz","ilkbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e3f2fd,#1565c0,#0d47a1)",      icon:"🌊", sephoraSlug:"sauvage-eau-de-parfum-P3807043"},
  {id:26, name:"Bleu de Chanel",               brand:"Chanel",            gender:["erkek"],                 mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["odunsu","narenciye"], budget:["premium","lüks"], notes:["Greyfurt","Sedir","Sandal"],                price:"₺10.500–₺16.800", match:93, season:["tüm_sezonlar"],        ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#e3f2fd,#42a5f5,#1565c0)",      icon:"💎", sephoraSlug:"bleu-de-chanel-P271678"},
  {id:27, name:"Armani Acqua di Giò",          brand:"Giorgio Armani",    gender:["erkek","unisex"],        mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["orta"],           notes:["Deniz Notası","Bergamot","Patchouli"],      price:"₺7.500–₺11.500", match:90, season:["yaz"],                 ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e0f7fa,#00bcd4,#006064)",      icon:"🌊", sephoraSlug:"armani-acqua-di-gio-P300672"},
  {id:28, name:"Armani Code",                  brand:"Giorgio Armani",    gender:["erkek"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta","premium"], notes:["Bergamot","Zeytin","Tonga Fasulyesi"],      price:"₺7.800–₺12.000", match:91, season:["sonbahar","kış"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#1a237e,#283593,#0d47a1)",      icon:"🖤", sephoraSlug:"armani-code-P271676"},
  {id:29, name:"Versace Eros",                 brand:"Versace",           gender:["erkek"],                 mood:["romantik","sofistike"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta"],           notes:["Nane","Tonga Fasulyesi","Vetiver"],         price:"₺6.500–₺10.200", match:88, season:["sonbahar","kış"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e3f2fd,#1e88e5,#1a237e)",      icon:"⚡", sephoraSlug:"versace-eros-P300671"},
  {id:30, name:"Paco Rabanne 1 Million",       brand:"Paco Rabanne",      gender:["erkek"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["orta","premium"], notes:["Kan Portakalı","Tarçın","Deri"],            price:"₺7.200–₺10.800", match:91, season:["kış","sonbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#fff8e1,#ffd54f,#ff6f00)",      icon:"💰", sephoraSlug:"paco-rabanne-1-million-P300673"},
  {id:31, name:"Paco Rabanne Invictus",        brand:"Paco Rabanne",      gender:["erkek"],                 mood:["taze","romantik"],      occasion:["günlük"],         family:["narenciye","odunsu"], budget:["orta"],           notes:["Greyfurt","Deniz Akkordu","Guaiac"],        price:"₺6.800–₺10.500", match:87, season:["yaz","ilkbahar"],      ageGroup:["genç"],           color:"linear-gradient(160deg,#e8f5e9,#66bb6a,#1b5e20)",      icon:"🏆", sephoraSlug:"paco-rabanne-invictus-P337614"},
  {id:32, name:"Hugo Boss Bottled",            brand:"Hugo Boss",         gender:["erkek"],                 mood:["doğal","taze"],         occasion:["günlük","iş"],    family:["odunsu"],             budget:["ekonomik","orta"],notes:["Elma","Sedir","Sandal"],                    price:"₺3.800–₺6.200", match:83, season:["tüm_sezonlar"],        ageGroup:["tüm_yaşlar"],     color:"linear-gradient(160deg,#efebe9,#a1887f,#4e342e)",      icon:"🍎", sephoraSlug:"hugo-boss-bottled-P113553"},
  {id:33, name:"Hugo Boss The Scent",          brand:"Hugo Boss",         gender:["erkek"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta"],           notes:["Zencefil","Kakao","Deri"],                  price:"₺5.800–₺9.200", match:87, season:["kış","sonbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#212121,#37474f,#bf360c)",      icon:"🔥", sephoraSlug:"hugo-boss-the-scent-P395553"},
  {id:34, name:"Mont Blanc Legend",            brand:"Mont Blanc",        gender:["erkek"],                 mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["odunsu"],             budget:["ekonomik","orta"],notes:["Bergamot","Lavanta","Okyanus"],             price:"₺3.200–₺5.500", match:82, season:["yaz","ilkbahar"],      ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e3f2fd,#90caf9,#1565c0)",      icon:"⛰️", sephoraSlug:"mont-blanc-legend-P379524"},
  {id:35, name:"Terre d'Hermès",               brand:"Hermès",            gender:["erkek","unisex"],        mood:["doğal","sofistike"],    occasion:["iş","günlük"],    family:["odunsu"],             budget:["premium","lüks"], notes:["Portakal","Flint","Vetiver"],               price:"₺10.500–₺16.000", match:92, season:["sonbahar","kış"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#fff3e0,#ff8a65,#bf360c)",      icon:"🌍", sephoraSlug:"terre-d-hermes-P179892"},
  {id:36, name:"Tom Ford Oud Wood",            brand:"Tom Ford",          gender:["erkek","unisex"],        mood:["sofistike","doğal"],    occasion:["gece","özel"],    family:["odunsu","oryantal"],  budget:["lüks"],           notes:["Oud","Sandal","Vetiver"],                   price:"₺18.500–₺26.000",match:97, season:["kış","sonbahar"],      ageGroup:["olgun"],          color:"linear-gradient(160deg,#3e2723,#5d4037,#d4a017)",      icon:"🪵", sephoraSlug:"tom-ford-oud-wood-P229550"},
  {id:37, name:"Tom Ford Tobacco Vanille",     brand:"Tom Ford",          gender:["erkek","unisex"],        mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["lüks"],           notes:["Tütün","Vanilya","Kakao"],                  price:"₺17.500–₺24.500",match:94, season:["kış"],                 ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#4e342e,#795548,#ffe082)",      icon:"🍂", sephoraSlug:"tom-ford-tobacco-vanille-P229551"},
  {id:38, name:"Baccarat Rouge 540",           brand:"MFK",               gender:["unisex","kadın","erkek"],mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["lüks"],           notes:["Safran","Amberwood","Jasmin"],              price:"₺22.000–₺32.000",match:98, season:["kış","sonbahar"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#fff8e1,#ffca28,#e65100)",      icon:"💎", sephoraSlug:"baccarat-rouge-540-P393581"},
  {id:39, name:"Le Labo Santal 33",            brand:"Le Labo",           gender:["unisex"],                mood:["doğal","sofistike"],    occasion:["günlük","özel"],  family:["odunsu"],             budget:["lüks"],           notes:["Sandal","Sedir","Deri"],                    price:"₺17.500–₺25.000",match:94, season:["tüm_sezonlar"],        ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#efebe9,#d7ccc8,#795548)",      icon:"🌿", sephoraSlug:"le-labo-santal-33-P380011"},
  {id:40, name:"Byredo Bal d'Afrique",         brand:"Byredo",            gender:["unisex"],                mood:["doğal","sofistike"],    occasion:["günlük","iş"],    family:["çiçeksi","odunsu"],   budget:["lüks"],           notes:["Bergamot","Neroli","Vetiver"],              price:"₺17.500–₺25.000",match:92, season:["yaz","ilkbahar"],      ageGroup:["orta"],           color:"linear-gradient(160deg,#fffde7,#fff176,#f9a825)",      icon:"🌞", sephoraSlug:"byredo-bal-d-afrique-P414499"},
  {id:41, name:"Creed Aventus",                brand:"Creed",             gender:["erkek","unisex"],        mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["narenciye","odunsu"], budget:["lüks"],           notes:["Ananas","Huş Ağacı","Misk"],               price:"₺32.000–₺45.000",match:96, season:["tüm_sezonlar"],        ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#e8f5e9,#43a047,#1b5e20)",      icon:"🏆", sephoraSlug:"creed-aventus-P390098"},
  {id:42, name:"Jo Malone Lime Basil",         brand:"Jo Malone",         gender:["unisex"],                mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye"],          budget:["premium","lüks"], notes:["Misket Limonu","Fesleğen","Amber"],         price:"₺10.500–₺16.000", match:88, season:["yaz"],                 ageGroup:["tüm_yaşlar"],     color:"linear-gradient(160deg,#f1f8e9,#aed581,#558b2f)",      icon:"🍋", sephoraSlug:"jo-malone-lime-basil-mandarin-P10005"},
  {id:43, name:"Jo Malone Peony Blush Suede",  brand:"Jo Malone",         gender:["kadın","unisex"],        mood:["romantik","sofistike"], occasion:["özel","günlük"],  family:["çiçeksi"],            budget:["premium","lüks"], notes:["Şakayık","Elma","Süet"],                   price:"₺10.500–₺16.000", match:91, season:["ilkbahar"],            ageGroup:["orta"],           color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#ef9a9a)",      icon:"🌸", sephoraSlug:"jo-malone-peony-blush-suede-P390100"},
  {id:44, name:"Maison Margiela Beach Walk",   brand:"Maison Margiela",   gender:["unisex","kadın"],        mood:["taze","doğal"],         occasion:["günlük","özel"],  family:["narenciye","odunsu"], budget:["premium","lüks"], notes:["Limon","Hindistan Cevizi","Misk"],          price:"₺10.500–₺16.000", match:89, season:["yaz"],                 ageGroup:["genç","orta"],    color:"linear-gradient(160deg,#e0f7fa,#80cbc4,#004d40)",      icon:"🏖️", sephoraSlug:"maison-margiela-replica-beach-walk-P419041"},
  {id:45, name:"Diptyque Philosykos",          brand:"Diptyque",          gender:["unisex"],                mood:["doğal","taze"],         occasion:["günlük"],         family:["odunsu"],             budget:["premium","lüks"], notes:["İncir Ağacı","Odun","Sütlü Notalar"],      price:"₺11.500–₺17.000", match:87, season:["yaz","ilkbahar"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#f1f8e9,#c5e1a5,#558b2f)",      icon:"🌳", sephoraSlug:"diptyque-philosykos-P352022"},
  ...
  {id:54, name:"Givenchy L'Interdit",          brand:"Givenchy",          gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["çiçeksi","odunsu"],   budget:["premium"],        notes:["Tuberose","Beyaz Misk","Vetiver"],          price:"₺8.500–₺12.800", match:90, season:["kış","sonbahar"],      ageGroup:["orta","olgun"],   color:"linear-gradient(160deg,#212121,#424242,#fce4ec)",      icon:"🖤", sephoraSlug:"givenchy-l-interdit-P432872"},
  ...
  // KADIN
  {id:61,  name:"Zara Tender Amber",            brand:"Zara", gender:["kadın","unisex"],        mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["oryantal"],           budget:["ekonomik"], notes:["Amber","Gül","Sümbülteber","Egzotik Meyve"],  price:"₺1.250", match:83, season:["sonbahar","kış"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fff8e1,#ffca28,#e65100)", icon:"🍯", sephoraSlug:null},
  {id:62,  name:"Zara Tender Amber Intense",    brand:"Zara", gender:["kadın","unisex"],        mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"], notes:["Safran","Amber","Laden Reçinesi","Siyah Frenk Üzümü"], price:"₺1.390", match:85, season:["kış"],          ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#bf360c,#e65100,#ffd54f)", icon:"🔥", sephoraSlug:null},
  {id:63,  name:"Zara Applejuice",              brand:"Zara", gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi","narenciye"],budget:["ekonomik"], notes:["Elma","Yasemin","Beyaz Misk"],                price:"₺950–₺1.150", match:80, season:["ilkbahar","yaz"], ageGroup:["genç"],         color:"linear-gradient(160deg,#f1f8e9,#aed581,#fff9c4)", icon:"🍎", sephoraSlug:null},
  {id:64,  name:"Zara Lightly Bloom",           brand:"Zara", gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi"],            budget:["ekonomik"], notes:["Şakayık","Gül","Bergamot","Misk"],            price:"₺950–₺1.150", match:78, season:["ilkbahar","yaz"], ageGroup:["genç"],         color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#f48fb1)", icon:"🌸", sephoraSlug:null},
  {id:65,  name:"Zara Gardenia",                brand:"Zara", gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["ekonomik"], notes:["Gardenia","Vanilya","Kahve","Misk"],          price:"₺950–₺1.150", match:79, season:["kış","sonbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#212121,#424242,#ffd54f)", icon:"🖤", sephoraSlug:null},
  {id:66,  name:"Zara Femme",                   brand:"Zara", gender:["kadın"],                 mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"], notes:["Badem","Misk","Amber","Tatlı Meyve"],         price:"₺1.050–₺1.250", match:77, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#880e4f,#c2185b,#ede7f6)", icon:"💜", sephoraSlug:null},
  {id:67,  name:"Zara Barbie",                  brand:"Zara", gender:["kadın"],                 mood:["romantik","taze"],      occasion:["günlük","özel"],  family:["çiçeksi","oryantal"], budget:["ekonomik"], notes:["Marshmallow","Gül","Vanilya","Misk"],         price:"₺1.050–₺1.250", match:76, season:["ilkbahar","yaz"], ageGroup:["genç"],         color:"linear-gradient(160deg,#f06292,#f8bbd0,#fff9c4)", icon:"🩷", sephoraSlug:null},
  {id:68,  name:"Zara Amber in Bloom",          brand:"Zara", gender:["kadın"],                 mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["çiçeksi","oryantal"], budget:["ekonomik"], notes:["Yasemin","Tuberose","Amber","Kaşmeran"],      price:"₺1.150–₺1.350", match:81, season:["sonbahar","kış"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#fff3e0,#ffb74d,#e65100)", icon:"🌺", sephoraSlug:null},
  {id:69,  name:"Zara Amber Satin",             brand:"Zara", gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"], notes:["Amber","Sandal","Vanilya","Misk"],            price:"₺1.150–₺1.350", match:80, season:["kış"],             ageGroup:["orta"],         color:"linear-gradient(160deg,#efebe9,#d7ccc8,#ff8a65)", icon:"✨", sephoraSlug:null},
  {id:70,  name:"Zara Amber Fever",             brand:"Zara", gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["ekonomik"], notes:["Orkide","Bourbon Vanyalası","Altın Amber"],   price:"₺1.150–₺1.350", match:82, season:["kış","sonbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#4a148c,#7b1fa2,#ffca28)", icon:"🌟", sephoraSlug:null},
  {id:71,  name:"Zara Stellar Amber",           brand:"Zara", gender:["unisex"],                mood:["sofistike"],            occasion:["özel","gece"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Amber","Sedir","Rezin","Beyaz Misk"],         price:"₺1.250–₺1.450", match:84, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#1a237e,#283593,#ffd54f)", icon:"⭐", sephoraSlug:null},
  {id:72,  name:"Zara Fleur d'Oranger",        brand:"Zara", gender:["kadın","unisex"],        mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["çiçeksi","narenciye"],budget:["ekonomik"], notes:["Portakal Çiçeği","Bergamot","Misk"],          price:"₺950–₺1.150", match:77, season:["yaz","ilkbahar"],  ageGroup:["tüm_yaşlar"],   color:"linear-gradient(160deg,#fff8e1,#ffe082,#fb8c00)", icon:"🌼", sephoraSlug:null},
  {id:73,  name:"Zara Cherry Smoothie",         brand:"Zara", gender:["kadın"],                 mood:["romantik","taze"],      occasion:["günlük","özel"],  family:["çiçeksi","narenciye"],budget:["ekonomik"], notes:["Kiraz","Gül","Vanilya","Amber"],              price:"₺1.050–₺1.250", match:79, season:["ilkbahar","yaz"], ageGroup:["genç"],         color:"linear-gradient(160deg,#880e4f,#e91e63,#fce4ec)", icon:"🍒", sephoraSlug:null},
  {id:74,  name:"Zara Cashmere Rose",           brand:"Zara", gender:["kadın","hediye"],        mood:["romantik","taze"],      occasion:["günlük"],         family:["çiçeksi"],            budget:["ekonomik"], notes:["Gül","Yasemin","Kaşmir","Misk"],              price:"₺950–₺1.150", match:78, season:["ilkbahar"],        ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#efebe9)", icon:"🌹", sephoraSlug:null},
  {id:75,  name:"Zara Supreme Vanilla",         brand:"Zara", gender:["kadın"],                 mood:["romantik","sofistike"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"], notes:["Vanilya","Kahve","Pralin","Amber"],           price:"₺1.050–₺1.250", match:80, season:["kış"],             ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fff8e1,#ffe082,#795548)", icon:"🍮", sephoraSlug:null},
  {id:76,  name:"Zara Starlight Vanilla",       brand:"Zara", gender:["kadın","unisex"],        mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"], notes:["Vanilya","Tonka Fasulyesi","Misk","Sandal"],  price:"₺1.150–₺1.350", match:81, season:["kış"],             ageGroup:["orta"],         color:"linear-gradient(160deg,#fffde7,#fff176,#f9a825)", icon:"🌙", sephoraSlug:null},
  {id:77,  name:"Zara Hypnotic Vanilla",        brand:"Zara", gender:["kadın"],                 mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"], notes:["Vanilya","Badem","Amber","Misk"],             price:"₺1.050–₺1.250", match:79, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#3e2723,#5d4037,#ffe082)", icon:"🍦", sephoraSlug:null},
  {id:78,  name:"Zara Frosted Cream",           brand:"Zara", gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük","iş"],    family:["çiçeksi"],            budget:["ekonomik"], notes:["Bergamot","Şakayık","Sandal","Misk"],         price:"₺950–₺1.150", match:76, season:["ilkbahar","yaz"], ageGroup:["genç"],         color:"linear-gradient(160deg,#f3e5f5,#e1bee7,#fff3e0)", icon:"🤍", sephoraSlug:null},
  {id:79,  name:"Zara Sublime Epoque",          brand:"Zara", gender:["kadın"],                 mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["çiçeksi","odunsu"],   budget:["ekonomik"], notes:["Portakal Çiçeği","Tuberose","Sandal"],        price:"₺1.050–₺1.250", match:78, season:["tüm_sezonlar"],    ageGroup:["orta"],         color:"linear-gradient(160deg,#e8f5e9,#a5d6a7,#ffffff)", icon:"💐", sephoraSlug:null},
  {id:80,  name:"Zara Sense of Glam",           brand:"Zara", gender:["kadın"],                 mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["çiçeksi","oryantal"], budget:["ekonomik"], notes:["Pudra","Gül","Ruj Notu","Sandal"],            price:"₺1.050–₺1.250", match:77, season:["sonbahar"],        ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#fce4ec,#f48fb1,#ef9a9a)", icon:"💋", sephoraSlug:null},
  {id:81,  name:"Zara Go Fruity",               brand:"Zara", gender:["kadın","hediye"],        mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi","narenciye"],budget:["ekonomik"], notes:["Kırmızı Meyve","Frenk Üzümü","Misk"],        price:"₺950–₺1.150", match:76, season:["yaz","ilkbahar"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#e91e63,#f48fb1,#fff9c4)", icon:"🍓", sephoraSlug:null},
  {id:82,  name:"Zara Amber Fig Cashmere",      brand:"Zara", gender:["kadın","unisex"],        mood:["doğal","sofistike"],    occasion:["günlük","özel"],  family:["odunsu","oryantal"],  budget:["ekonomik"], notes:["Amber","İncir","Kaşmir","Sandal"],            price:"₺1.150–₺1.350", match:80, season:["sonbahar","kış"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#fff3e0,#ffcc80,#8d6e63)", icon:"🌿", sephoraSlug:null},
  {id:83,  name:"Zara Soleil Decade",           brand:"Zara", gender:["kadın"],                 mood:["taze","doğal"],         occasion:["yaz","günlük"],   family:["narenciye","odunsu"], budget:["ekonomik"], notes:["Bergamot","Bronz Notu","Hindistan Cevizi"],   price:"₺1.050–₺1.250", match:76, season:["yaz"],             ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fff8e1,#ffb300,#e65100)", icon:"☀️", sephoraSlug:null},
  // ERKEK
  {id:84,  name:"Zara Aromatic Future",         brand:"Zara", gender:["erkek"],                 mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["ekonomik"], notes:["Bergamot","Lavanta","Sedir","Ambroxan"],      price:"₺1.050–₺1.250", match:79, season:["yaz","ilkbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e3f2fd,#1565c0,#0d47a1)", icon:"🌊", sephoraSlug:null},
  {id:85,  name:"Zara Amber Ego",               brand:"Zara", gender:["erkek"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Amber","Vanilya","Zencefil","Sedir"],         price:"₺1.150–₺1.350", match:80, season:["kış","sonbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#3e2723,#6d4c41,#ffd54f)", icon:"🏆", sephoraSlug:null},
  {id:86,  name:"Zara Black Amber",             brand:"Zara", gender:["erkek"],                 mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Tütün","Amber","Sandal","Misk"],              price:"₺1.150–₺1.350", match:81, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#212121,#37474f,#ffd54f)", icon:"🔴", sephoraSlug:null},
  {id:87,  name:"Zara Vibrant Leather",         brand:"Zara", gender:["erkek","unisex"],        mood:["sofistike","doğal"],    occasion:["iş","özel"],      family:["odunsu","oryantal"],  budget:["ekonomik"], notes:["Deri","Sedir","Bergamot","Vetiver"],          price:"₺1.150–₺1.350", match:78, season:["sonbahar","kış"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#3e2723,#5d4037,#90a4ae)", icon:"🪨", sephoraSlug:null},
  {id:88,  name:"Zara Exclusive Oud",           brand:"Zara", gender:["erkek","unisex"],        mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Oud","Safran","Gül","Reçine"],                price:"₺1.250–₺1.500", match:82, season:["kış"],             ageGroup:["olgun"],        color:"linear-gradient(160deg,#1a0a00,#3e2723,#d4a017)", icon:"🕌", sephoraSlug:null},
  {id:89,  name:"Zara Blue Spirit",             brand:"Zara", gender:["erkek"],                 mood:["taze","doğal"],         occasion:["günlük"],         family:["narenciye","odunsu"], budget:["ekonomik"], notes:["Deniz","Greyfurt","Guaiac Ağacı"],            price:"₺950–₺1.150", match:77, season:["yaz","ilkbahar"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#e8f5e9,#4caf50,#1b5e20)", icon:"💚", sephoraSlug:null},
  {id:90,  name:"Zara For Him",                 brand:"Zara", gender:["erkek"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Bergamot","Tütün","Sandal"],                  price:"₺1.050–₺1.250", match:78, season:["kış","sonbahar"],  ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#1a237e,#283593,#90a4ae)", icon:"🖤", sephoraSlug:null},
  {id:91,  name:"Zara London Savile Row",       brand:"Zara", gender:["erkek"],                 mood:["taze","sofistike"],     occasion:["iş","günlük"],    family:["odunsu","narenciye"], budget:["ekonomik"], notes:["Elma","Sage","Sedir","Amber"],                price:"₺1.050–₺1.250", match:77, season:["tüm_sezonlar"],    ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#37474f,#546e7a,#ffe082)", icon:"🎩", sephoraSlug:null},
  {id:92,  name:"Zara Bohemian Oud",            brand:"Zara", gender:["erkek","unisex"],        mood:["doğal","sofistike"],    occasion:["özel","gece"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Oud","Duman","Kestane","Ahşap"],              price:"₺1.150–₺1.350", match:79, season:["kış"],             ageGroup:["orta"],         color:"linear-gradient(160deg,#212121,#4e342e,#8d6e63)", icon:"🪵", sephoraSlug:null},
  {id:93,  name:"Zara Man Gold",                brand:"Zara", gender:["erkek"],                 mood:["sofistike","taze"],     occasion:["iş","günlük"],    family:["odunsu","narenciye"], budget:["ekonomik"], notes:["Bergamot","Sedir","Amber","Misk"],            price:"₺1.050–₺1.250", match:76, season:["tüm_sezonlar"],    ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fff8e1,#ffd54f,#f57f17)", icon:"⚜️", sephoraSlug:null},
  {id:94,  name:"Zara Soft Haze",               brand:"Zara", gender:["erkek","unisex"],        mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["ekonomik"], notes:["Bergamot","Gün Işığı Çayı","Gümüş Misk"],    price:"₺950–₺1.150", match:77, season:["yaz","ilkbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#eceff1,#cfd8dc,#b0bec5)", icon:"🌫️", sephoraSlug:null},
  {id:95,  name:"Zara Tobacco Collection Rich", brand:"Zara", gender:["erkek","unisex"],        mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik"], notes:["Tütün","Vanilya","Kakao","Tonka"],             price:"₺1.150–₺1.350", match:82, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#4e342e,#6d4c41,#ffe082)", icon:"🍂", sephoraSlug:null},
  {id:96,  name:"Zara Waterfall Brume",         brand:"Zara", gender:["unisex","kadın"],        mood:["taze","doğal"],         occasion:["günlük"],         family:["narenciye"],          budget:["ekonomik"], notes:["Citrus","Su Notalı","Yeşillik","Misk"],        price:"₺850–₺1.050", match:74, season:["yaz"],             ageGroup:["genç","tüm_yaşlar"],color:"linear-gradient(160deg,#e0f7fa,#80deea,#00838f)", icon:"💦", sephoraSlug:null},
  {id:97,  name:"Zara Ebony Wood",              brand:"Zara", gender:["erkek","unisex"],        mood:["doğal","sofistike"],    occasion:["günlük","iş"],    family:["odunsu"],             budget:["ekonomik"], notes:["Sedir","Deniz Tuzu","Ada Çayı","Misk"],       price:"₺1.050–₺1.250", match:78, season:["sonbahar"],        ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#212121,#37474f,#546e7a)", icon:"🌲", sephoraSlug:null},

  // ── LATTAFA (Arap Niş) ──────────────────────────────────
  {id:98,  name:"Lattafa Khamrah",              brand:"Lattafa", gender:["unisex"],             mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik","orta"], notes:["Üzüm","Amber","Vanilya","Sandal"],            price:"₺800–₺1.300",  match:88, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#4a148c,#880e4f,#ffd54f)", icon:"🍇", sephoraSlug:null},
  {id:99,  name:"Lattafa Asad",                 brand:"Lattafa", gender:["erkek","unisex"],     mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Oud","Deri","Amber","Vetiver"],               price:"₺750–₺1.200",  match:85, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#1a0a00,#4e342e,#d4a017)", icon:"🦁", sephoraSlug:null},
  {id:100, name:"Lattafa Raghba",               brand:"Lattafa", gender:["unisex"],             mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"],        notes:["Amber","Vanilya","Sandal","Misk"],            price:"₺650–₺1.000",  match:82, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#e65100,#ff8f00,#ffd54f)", icon:"✨", sephoraSlug:null},
  {id:101, name:"Lattafa Oud Mood",             brand:"Lattafa", gender:["unisex"],             mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Oud","Gül","Amber","Sandal"],                 price:"₺350–₺650",  match:84, season:["kış"],             ageGroup:["olgun"],        color:"linear-gradient(160deg,#3e2723,#6d4c41,#d4a017)", icon:"🕌", sephoraSlug:null},
  {id:102, name:"Lattafa Yara",                 brand:"Lattafa", gender:["kadın","unisex"],     mood:["romantik","taze"],      occasion:["günlük","özel"],  family:["çiçeksi","oryantal"], budget:["ekonomik"],        notes:["Liçi","Gül","Vanilya","Misk"],               price:"₺280–₺480",  match:80, season:["ilkbahar","yaz"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fce4ec,#f48fb1,#fff9c4)", icon:"🌸", sephoraSlug:null},
  {id:103, name:"Lattafa Yara Tous",            brand:"Lattafa", gender:["unisex"],             mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi","narenciye"],budget:["ekonomik"],        notes:["Bergamot","Şakayık","Misk"],                 price:"₺260–₺460",  match:78, season:["yaz","ilkbahar"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#e8f5e9,#80cbc4,#f8bbd0)", icon:"💐", sephoraSlug:null},
  {id:104, name:"Lattafa Oud Tamoh",            brand:"Lattafa", gender:["erkek","unisex"],     mood:["sofistike","doğal"],    occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Oud","Sandal","Gül","Patchouli"],             price:"₺350–₺650",  match:83, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#1a0a00,#3e2723,#bf360c)", icon:"🔥", sephoraSlug:null},
  {id:105, name:"Lattafa Makhamariya",          brand:"Lattafa", gender:["unisex"],             mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik","orta"], notes:["Kırmızı Şarap","Amber","Safran","Vanilya"],  price:"₺380–₺680",  match:86, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#880e4f,#4a148c,#ffd54f)", icon:"🍷", sephoraSlug:null},
  {id:106, name:"Lattafa Badee Al Oud Amethyst",brand:"Lattafa", gender:["unisex"],             mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Oud","Safran","Gül","Amber"],                 price:"₺320–₺580",  match:81, season:["kış"],             ageGroup:["olgun"],        color:"linear-gradient(160deg,#4a148c,#6a1b9a,#d4a017)", icon:"💜", sephoraSlug:null},
  {id:107, name:"Lattafa Velvet Oud",           brand:"Lattafa", gender:["unisex","kadın"],     mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["oryantal","çiçeksi"], budget:["ekonomik"],        notes:["Gül","Oud","Vanilya","Misk"],                price:"₺300–₺520",  match:80, season:["sonbahar","kış"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#880e4f,#c62828,#ede7f6)", icon:"🌹", sephoraSlug:null},

  // ── RASASI ──────────────────────────────────────────────
  {id:108, name:"Rasasi Hawas",                 brand:"Rasasi", gender:["erkek","unisex"],      mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["ekonomik","orta"], notes:["Bergamot","Lavanta","Amber"],                 price:"₺350–₺650",  match:84, season:["yaz","ilkbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e3f2fd,#1565c0,#e0f7fa)", icon:"🌊", sephoraSlug:null},
  {id:109, name:"Rasasi La Yuqawam Homme",      brand:"Rasasi", gender:["erkek"],               mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Tütün","Deri","Amber","Sandal"],              price:"₺380–₺680",  match:85, season:["kış","sonbahar"],  ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#212121,#4e342e,#bf360c)", icon:"🎯", sephoraSlug:null},
  {id:110, name:"Rasasi Egra",                  brand:"Rasasi", gender:["kadın"],               mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi","narenciye"],budget:["ekonomik"],        notes:["Bergamot","Gül","Misk"],                     price:"₺280–₺500",  match:77, season:["ilkbahar","yaz"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#e0f7fa)", icon:"🌸", sephoraSlug:null},
  {id:111, name:"Rasasi Qasamat Bokhoor",       brand:"Rasasi", gender:["unisex"],              mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["ekonomik","orta"], notes:["Oud","Buhur","Amber","Sandal"],               price:"₺350–₺650",  match:83, season:["kış"],             ageGroup:["olgun"],        color:"linear-gradient(160deg,#3e2723,#bf360c,#ffd54f)", icon:"🕌", sephoraSlug:null},
  {id:112, name:"Rasasi Junoon",                brand:"Rasasi", gender:["erkek"],               mood:["taze","sofistike"],     occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["ekonomik"],        notes:["Bergamot","Sedir","Vetiver"],                 price:"₺280–₺500",  match:79, season:["tüm_sezonlar"],    ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#1a237e,#0288d1,#e0f7fa)", icon:"⚡", sephoraSlug:null},

  // ── ARMAF ───────────────────────────────────────────────
  {id:113, name:"Armaf Club de Nuit Intense",   brand:"Armaf", gender:["erkek","unisex"],       mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["narenciye","odunsu"], budget:["orta"],            notes:["Ananas","Bergamot","Huş Ağacı","Misk"],      price:"₺1.200–₺1.800",  match:90, season:["tüm_sezonlar"],    ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#1a237e,#283593,#e8f5e9)", icon:"🏆", sephoraSlug:null},
  {id:114, name:"Armaf Club de Nuit Women",     brand:"Armaf", gender:["kadın"],                mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["orta"],            notes:["Gül","Misk","Vetiver","Amber"],               price:"₺500–₺900",  match:87, season:["sonbahar","kış"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#880e4f,#c2185b,#fce4ec)", icon:"💎", sephoraSlug:null},
  {id:115, name:"Armaf Tres Nuit",              brand:"Armaf", gender:["erkek"],                mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["orta"],            notes:["Limon","Elma","Sedir","Amber"],               price:"₺450–₺800",  match:83, season:["yaz","ilkbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e3f2fd,#42a5f5,#0d47a1)", icon:"🌙", sephoraSlug:null},
  {id:116, name:"Armaf Tag Her",                brand:"Armaf", gender:["kadın","hediye"],       mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi","narenciye"],budget:["orta"],            notes:["Bergamot","Gül","Sandal","Misk"],             price:"₺450–₺800",  match:82, season:["ilkbahar","yaz"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#fce4ec,#f48fb1,#fff9c4)", icon:"🎀", sephoraSlug:null},
  {id:117, name:"Armaf Shades Fume",            brand:"Armaf", gender:["erkek","unisex"],       mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta"],            notes:["Tütün","Deri","Sandal","Amber"],              price:"₺500–₺900",  match:85, season:["kış","sonbahar"],  ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#212121,#4e342e,#90a4ae)", icon:"🔥", sephoraSlug:null},

  // ── AVON ────────────────────────────────────────────────
  {id:118, name:"Avon Far Away",                brand:"Avon", gender:["kadın"],                  mood:["romantik","sofistike"], occasion:["gece","özel"],    family:["oryantal"],           budget:["ekonomik"],        notes:["Amber","Çiçek","Vanilya","Sandal"],           price:"₺250–₺450",  match:76, season:["kış","sonbahar"],  ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#fff8e1,#ffca28,#e65100)", icon:"✨", sephoraSlug:null},
  {id:119, name:"Avon Far Away Gold",           brand:"Avon", gender:["kadın"],                  mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["ekonomik"],        notes:["Gül","Amber","Vanilya","Misk"],               price:"₺280–₺480",  match:77, season:["kış"],             ageGroup:["orta"],         color:"linear-gradient(160deg,#fff8e1,#ffd54f,#ff8f00)", icon:"⭐", sephoraSlug:null},
  {id:120, name:"Avon Attraction",              brand:"Avon", gender:["kadın"],                  mood:["romantik","taze"],      occasion:["günlük","özel"],  family:["çiçeksi","oryantal"], budget:["ekonomik"],        notes:["Elma","Gül","Sandal","Amber"],                price:"₺220–₺420",  match:74, season:["ilkbahar","yaz"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fce4ec,#e91e63,#fff9c4)", icon:"💝", sephoraSlug:null},
  {id:121, name:"Avon Attraction Rush Erkek",   brand:"Avon", gender:["erkek"],                  mood:["taze","sofistike"],     occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["ekonomik"],        notes:["Bergamot","Sedir","Amber"],                   price:"₺220–₺420",  match:73, season:["yaz","ilkbahar"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#1a237e,#283593,#e8f5e9)", icon:"⚡", sephoraSlug:null},
  {id:122, name:"Avon Eve Elegance",            brand:"Avon", gender:["kadın"],                  mood:["sofistike","romantik"], occasion:["iş","özel"],      family:["çiçeksi"],            budget:["ekonomik"],        notes:["Portakal Çiçeği","Gül","Sandal"],             price:"₺200–₺380",  match:72, season:["tüm_sezonlar"],    ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#ede7f6,#b39ddb,#fce4ec)", icon:"👑", sephoraSlug:null},
  {id:123, name:"Avon Little Black Dress",      brand:"Avon", gender:["kadın"],                  mood:["sofistike"],            occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["ekonomik"],        notes:["Bergamot","Gül","Patchouli","Amber"],         price:"₺220–₺400",  match:74, season:["sonbahar","kış"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#212121,#424242,#fce4ec)", icon:"🖤", sephoraSlug:null},

  // ── ORİFLAME ───────────────────────────────────────────
  {id:124, name:"Oriflame Miss Giordani",       brand:"Oriflame", gender:["kadın","hediye"],     mood:["taze","romantik"],      occasion:["günlük"],         family:["çiçeksi"],            budget:["ekonomik"],        notes:["Bergamot","Gül","Misk"],                     price:"₺300–₺550",  match:75, season:["ilkbahar","yaz"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fce4ec,#f48fb1,#ffffff)", icon:"🌹", sephoraSlug:null},
  {id:125, name:"Oriflame Eclat Mon Parfum",    brand:"Oriflame", gender:["kadın"],              mood:["taze","romantik"],      occasion:["günlük","iş"],    family:["çiçeksi","narenciye"],budget:["ekonomik"],        notes:["Bergamot","Şakayık","Sedir","Misk"],         price:"₺280–₺520",  match:76, season:["yaz","ilkbahar"],  ageGroup:["genç"],         color:"linear-gradient(160deg,#fff9c4,#ffe082,#fce4ec)", icon:"☀️", sephoraSlug:null},
  {id:126, name:"Oriflame Volare",              brand:"Oriflame", gender:["kadın"],              mood:["romantik","sofistike"], occasion:["özel","gece"],    family:["çiçeksi","oryantal"], budget:["ekonomik"],        notes:["Gül","Iris","Amber","Sandal"],               price:"₺300–₺550",  match:74, season:["sonbahar","kış"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#f3e5f5,#ce93d8,#ede7f6)", icon:"🦋", sephoraSlug:null},
  {id:127, name:"Oriflame Enigma Erkek",        brand:"Oriflame", gender:["erkek"],              mood:["sofistike","taze"],     occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["ekonomik"],        notes:["Bergamot","Sedir","Vetiver","Misk"],         price:"₺260–₺480",  match:73, season:["tüm_sezonlar"],    ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#37474f,#546e7a,#263238)", icon:"🎯", sephoraSlug:null},

  // ── YVES ROCHER ────────────────────────────────────────
  {id:128, name:"Yves Rocher Comme une Evidence",brand:"Yves Rocher", gender:["kadın"],          mood:["doğal","taze"],         occasion:["günlük"],         family:["çiçeksi"],            budget:["ekonomik","orta"], notes:["Gül","Mimoza","Iris","Sandal"],               price:"₺600–₺1.100", match:78, season:["ilkbahar"],        ageGroup:["orta"],         color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#f1f8e9)", icon:"🌿", sephoraSlug:null},
  {id:129, name:"Yves Rocher Nuit d'Orchidee",  brand:"Yves Rocher", gender:["kadın"],           mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["ekonomik","orta"], notes:["Orkide","Amber","Sandal"],                   price:"₺550–₺1.000", match:76, season:["kış","sonbahar"],  ageGroup:["orta"],         color:"linear-gradient(160deg,#4a148c,#7b1fa2,#fce4ec)", icon:"🌺", sephoraSlug:null},
  {id:130, name:"Yves Rocher Comme une Rose",   brand:"Yves Rocher", gender:["kadın","hediye"],  mood:["romantik","taze"],      occasion:["günlük","özel"],  family:["çiçeksi"],            budget:["ekonomik","orta"], notes:["Gül","Bergamot","Misk"],                     price:"₺500–₺900",  match:77, season:["ilkbahar","yaz"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fce4ec,#e91e63,#fce4ec)", icon:"🌹", sephoraSlug:null},
  {id:131, name:"Yves Rocher Verveine",         brand:"Yves Rocher", gender:["unisex"],          mood:["taze","doğal"],         occasion:["günlük"],         family:["narenciye"],          budget:["ekonomik"],        notes:["Limon Otu","Bergamot","Misk"],               price:"₺400–₺750",  match:74, season:["yaz"],             ageGroup:["tüm_yaşlar"],   color:"linear-gradient(160deg,#f1f8e9,#aed581,#fff9c4)", icon:"🍋", sephoraSlug:null},

  // ── DAHA FAZLA LÜX MARKA ───────────────────────────────
  {id:132, name:"Dolce & Gabbana The One Erkek",brand:"Dolce & Gabbana", gender:["erkek"],       mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta","premium"],  notes:["Tütün","Amber","Zencefil","Basil"],           price:"₺2.000–₺3.200", match:90, season:["kış","sonbahar"], ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#3e2723,#5d4037,#ffd54f)", icon:"🥃", sephoraSlug:null},
  {id:133, name:"Dolce & Gabbana Light Blue Erkek",brand:"Dolce & Gabbana",gender:["erkek"],     mood:["taze","doğal"],         occasion:["günlük","yaz"],   family:["narenciye","odunsu"], budget:["orta"],            notes:["Greyfurt","Sedir","Misk"],                   price:"₺1.800–₺2.800", match:87, season:["yaz"],             ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e3f2fd,#29b6f6,#0277bd)", icon:"💙", sephoraSlug:null},
  {id:134, name:"Prada Luna Rossa",             brand:"Prada", gender:["erkek"],                 mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["premium"],         notes:["Bergamot","Lavanta","Amber"],                 price:"₺3.200–₺5.000", match:88, season:["yaz","ilkbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e3f2fd,#1e88e5,#ffffff)", icon:"🌙", sephoraSlug:null},
  {id:135, name:"Prada L'Homme",               brand:"Prada", gender:["erkek"],                 mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["odunsu","narenciye"], budget:["premium"],         notes:["Iris","Amber","Sedir"],                      price:"₺3.000–₺4.800", match:89, season:["tüm_sezonlar"],    ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#efebe9,#d7ccc8,#e3f2fd)", icon:"👔", sephoraSlug:null},
  {id:136, name:"Valentino Donna Born in Roma", brand:"Valentino", gender:["kadın"],             mood:["taze","sofistike"],     occasion:["günlük","iş"],    family:["çiçeksi","odunsu"],   budget:["premium"],         notes:["Bergamot","Jasmin","Vanilya"],               price:"₺3.500–₺5.200", match:88, season:["ilkbahar","yaz"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#f3e5f5,#e1bee7,#fce4ec)", icon:"🌸", sephoraSlug:null},
  {id:137, name:"Jean Paul Gaultier Le Male",  brand:"Jean Paul Gaultier",gender:["erkek"],       mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal"],           budget:["orta","premium"],  notes:["Nane","Vanilya","Lavanta"],                  price:"₺2.200–₺3.400", match:89, season:["kış","sonbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e3f2fd,#0288d1,#fce4ec)", icon:"⚓", sephoraSlug:null},
  {id:138, name:"Jean Paul Gaultier Scandal",  brand:"Jean Paul Gaultier",gender:["kadın"],       mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["orta","premium"],  notes:["Kan Portakalı","Bal","Patchouli"],            price:"₺2.400–₺3.600", match:91, season:["kış","sonbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#bf360c,#e64a19,#fff8e1)", icon:"💋", sephoraSlug:null},
  {id:139, name:"Mugler Alien Goddess",        brand:"Mugler", gender:["kadın"],                 mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["premium"],         notes:["Bergamot","Vanilya","Kasturi Sandal"],        price:"₺3.800–₺5.500", match:90, season:["kış"],             ageGroup:["orta"],         color:"linear-gradient(160deg,#fff8e1,#ffca28,#f3e5f5)", icon:"👽", sephoraSlug:null},
  {id:140, name:"Rabanne Phantom",             brand:"Paco Rabanne", gender:["erkek"],            mood:["taze","sofistike"],     occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["premium"],         notes:["Limon","Lavanta","Vetiver","Vanilya"],        price:"₺2.800–₺4.200", match:87, season:["yaz","ilkbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#eceff1,#90a4ae,#fffde7)", icon:"🤖", sephoraSlug:null},
  {id:141, name:"Bulgari Omnia Crystalline",   brand:"Bulgari", gender:["kadın","hediye"],       mood:["taze","doğal"],         occasion:["günlük"],         family:["narenciye","çiçeksi"],budget:["orta","premium"],  notes:["Bambu","Hindistan Cevizi Çiçeği","Misk"],   price:"₺2.200–₺3.400", match:83, season:["yaz"],             ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e0f7fa,#b2ebf2,#ffffff)", icon:"💎", sephoraSlug:null},
  {id:142, name:"Emporio Armani Stronger With You",brand:"Emporio Armani",gender:["erkek"],       mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta","premium"],  notes:["Kardamom","Taba","Vanilya","Sedir"],          price:"₺2.600–₺4.000", match:90, season:["kış","sonbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#212121,#37474f,#fff8e1)", icon:"💪", sephoraSlug:null},
  {id:143, name:"Emporio Armani She",          brand:"Emporio Armani", gender:["kadın"],          mood:["taze","romantik"],      occasion:["günlük","iş"],    family:["çiçeksi"],            budget:["orta"],            notes:["Bergamot","Gül","Sandal"],                   price:"₺1.800–₺2.800", match:82, season:["ilkbahar","yaz"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#fce4ec,#f8bbd0,#e3f2fd)", icon:"💫", sephoraSlug:null},
  {id:144, name:"Calvin Klein Euphoria",       brand:"Calvin Klein", gender:["kadın"],            mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","çiçeksi"], budget:["orta"],            notes:["Nar","Lotus","Amber","Patchouli"],            price:"₺1.600–₺2.600", match:85, season:["sonbahar","kış"], ageGroup:["orta"],         color:"linear-gradient(160deg,#4a148c,#6a1b9a,#880e4f)", icon:"💜", sephoraSlug:null},
  {id:145, name:"Calvin Klein Obsession",      brand:"Calvin Klein", gender:["kadın"],            mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal"],           budget:["orta"],            notes:["Mandalina","Vanilya","Amber"],                price:"₺1.500–₺2.400", match:83, season:["kış"],             ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#bf360c,#e65100,#fff8e1)", icon:"🔥", sephoraSlug:null},
  {id:146, name:"Davidoff Cool Water Kadın",   brand:"Davidoff", gender:["kadın"],               mood:["taze","doğal"],         occasion:["günlük"],         family:["narenciye","çiçeksi"],budget:["ekonomik","orta"], notes:["Deniz","Çiçek","Sandal"],                    price:"₺600–₺1.100", match:76, season:["yaz"],             ageGroup:["genç"],         color:"linear-gradient(160deg,#e0f7fa,#80deea,#b2ebf2)", icon:"💦", sephoraSlug:null},
  {id:147, name:"Azzaro Wanted",               brand:"Azzaro", gender:["erkek"],                  mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","odunsu"],  budget:["orta"],            notes:["Limon","Kardamom","Vetiver"],                 price:"₺1.600–₺2.600", match:85, season:["kış","sonbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#1a237e,#283593,#ffe082)", icon:"⭐", sephoraSlug:null},
  {id:148, name:"Azzaro Chrome",               brand:"Azzaro", gender:["erkek"],                  mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["ekonomik","orta"], notes:["Bergamot","Anız","Sandal"],                  price:"₺700–₺1.300", match:78, season:["yaz","ilkbahar"],  ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#eceff1,#b0bec5,#e3f2fd)", icon:"✨", sephoraSlug:null},
  {id:149, name:"Issey Miyake L'Eau d'Issey Kadın",brand:"Issey Miyake",gender:["kadın"],         mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","çiçeksi"],budget:["orta"],            notes:["Lotus","Frezya","Amber"],                    price:"₺1.800–₺2.800", match:82, season:["yaz","ilkbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e0f7fa,#ffffff,#e8f5e9)", icon:"🌊", sephoraSlug:null},
  {id:150, name:"Givenchy Gentleman Society",  brand:"Givenchy", gender:["erkek"],               mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["odunsu","narenciye"], budget:["premium"],         notes:["Bergamot","Iris","Patchouli"],               price:"₺3.000–₺4.500", match:88, season:["tüm_sezonlar"],    ageGroup:["orta"],         color:"linear-gradient(160deg,#1a237e,#283593,#f3e5f5)", icon:"🎭", sephoraSlug:null},
  {id:151, name:"Lancôme Tresor Midnight Rose",brand:"Lancôme", gender:["kadın"],                 mood:["romantik","sofistike"], occasion:["gece","özel"],    family:["çiçeksi","oryantal"], budget:["premium"],         notes:["Ahududu","Gül","Patchouli"],                 price:"₺3.000–₺4.500", match:89, season:["kış","sonbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#880e4f,#e91e63,#1a237e)", icon:"🌹", sephoraSlug:null},
  {id:152, name:"YSL Opium",                   brand:"YSL", gender:["kadın"],                     mood:["sofistike"],            occasion:["gece","özel"],    family:["oryantal"],           budget:["premium"],         notes:["Karanfil","Gül","Amber","Sandal"],            price:"₺2.800–₺4.200", match:88, season:["kış"],             ageGroup:["olgun"],        color:"linear-gradient(160deg,#bf360c,#880e4f,#ffd54f)", icon:"💫", sephoraSlug:null},
  {id:153, name:"Gucci Guilty Erkek",          brand:"Gucci", gender:["erkek"],                   mood:["sofistike","romantik"], occasion:["gece","özel"],    family:["oryantal","narenciye"],budget:["premium"],        notes:["Limon","Lavanta","Amber"],                   price:"₺2.800–₺4.200", match:87, season:["sonbahar","kış"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#1a237e,#283593,#fff8e1)", icon:"🐍", sephoraSlug:null},
  {id:154, name:"Burberry Touch Kadın",         brand:"Burberry", gender:["kadın"],               mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["çiçeksi","narenciye"],budget:["orta"],            notes:["Bergamot","Şakayık","Sandal"],               price:"₺1.600–₺2.600", match:81, season:["ilkbahar","yaz"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#efebe9,#d7ccc8,#fce4ec)", icon:"🌼", sephoraSlug:null},
  {id:155, name:"Burberry Weekend Erkek",       brand:"Burberry", gender:["erkek"],               mood:["taze","doğal"],         occasion:["günlük"],         family:["narenciye","odunsu"], budget:["orta"],            notes:["Bergamot","Sedir","Sandal"],                 price:"₺1.600–₺2.600", match:80, season:["yaz","ilkbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#e8f5e9,#a5d6a7,#e3f2fd)", icon:"🌿", sephoraSlug:null},
  {id:156, name:"Narciso Rodriguez Bleu Noir",  brand:"Narciso Rodriguez",gender:["erkek"],        mood:["sofistike","taze"],     occasion:["iş","özel"],      family:["odunsu","narenciye"], budget:["orta","premium"],  notes:["Bergamot","Sedir","Misk"],                   price:"₺2.400–₺3.800", match:86, season:["tüm_sezonlar"],    ageGroup:["orta"],         color:"linear-gradient(160deg,#0d47a1,#1565c0,#37474f)", icon:"🔵", sephoraSlug:null},
  {id:157, name:"Versace Dylan Blue Kadın",     brand:"Versace", gender:["kadın"],                mood:["taze","sofistike"],     occasion:["günlük","iş"],    family:["narenciye","çiçeksi"],budget:["orta"],            notes:["Karpuz","Hibiskus","Misk"],                  price:"₺1.800–₺2.800", match:83, season:["yaz"],             ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#1a237e,#0288d1,#e0f7fa)", icon:"💙", sephoraSlug:null},
  {id:158, name:"Montblanc Explorer Platinum", brand:"Mont Blanc", gender:["erkek"],              mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["odunsu","narenciye"], budget:["orta"],            notes:["Greyfurt","Sedir","Vetiver"],                price:"₺1.600–₺2.600", match:83, season:["yaz","ilkbahar"], ageGroup:["genç","orta"],  color:"linear-gradient(160deg,#eceff1,#b0bec5,#37474f)", icon:"🏔️", sephoraSlug:null},
  {id:159, name:"Cartier Declaration",          brand:"Cartier", gender:["erkek"],               mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["premium","lüks"],  notes:["Kardamom","Sedir","Vetiver"],                price:"₺2.800–₺4.500", match:87, season:["ilkbahar","yaz"], ageGroup:["orta","olgun"], color:"linear-gradient(160deg,#fff8e1,#ffd54f,#37474f)", icon:"💍", sephoraSlug:null},
  {id:160, name:"Hermes Terre d'Hermes Eau Givrée",brand:"Hermès",gender:["erkek","unisex"],      mood:["taze","doğal"],         occasion:["günlük","iş"],    family:["narenciye","odunsu"], budget:["premium","lüks"],  notes:["Greyfurt","Flint","Vetiver"],                price:"₺4.500–₺7.000", match:89, season:["yaz","ilkbahar"], ageGroup:["orta"],         color:"linear-gradient(160deg,#e0f7fa,#fff3e0,#bf360c)", icon:"🍊", sephoraSlug:null},
];
  ...
  shops.push(
    {
      ...
      badge: (!isZara && !verifiedSlug) ? "🔥 Popüler" : null,
    },
    {
      icon:"🌐",
      label:"Douglas TR",
...
.card-foot{display:flex;flex-direction:column;gap:10px;padding-top:16px;border-top:1.5px solid var(--sand);}
.card-foot-top{display:flex;justify-content:space-between;align-items:center;}
.card-foot-btns{display:flex;gap:8px;width:100%;}
.card-foot-btns .alt-btn{flex:1;min-width:0;font-size:11px;padding:9px 8px;}
.card-foot-btns .buy-btn{flex:1;min-width:0;font-size:11px;padding:9px 8px;white-space:nowrap;}
...
/* RESTART */
.chat-fab{position:fixed;bottom:28px;right:24px;z-index:300;width:58px;height:58px;border-radius:50%;background:linear-gradient(135deg,var(--rose),var(--rose2));border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:24px;box-shadow:0 8px 24px rgba(232,56,109,.4);transition:all .25s;}
...
const FRAGELLA_KEY = "48c5739363787ee44e2fede1f7ed4b7394f2f84d2aaed7aa1eec0619f7a8b6b7";
const imgCache = {};
...
function PerfumeBottle({ perfume }) {
  ...
  useEffect(() => {
    const key = perfume.name;
    if (imgCache[key]) {
      setImgUrl(imgCache[key]);
      setLoading(false);
      return;
    }

    const searchName = perfume.name
      .replace("Zara ", "")
      .replace("Viktor & Rolf", "Viktor&Rolf")
      .replace("Dolce & Gabbana", "Dolce&Gabbana");

    // Fragella widget üzerinden fotoğraf çek
    const tryFragella = () => {
      if (window.Fragella) {
        window.Fragella.search(searchName, 1).then(data => {
          const url = data?.[0]?.["Image URL Transparent"] || data?.[0]?.["Image URL"] || null;
          if (url) { imgCache[key] = url; setImgUrl(url); }
          else setError(true);
          setLoading(false);
        }).catch(() => { setError(true); setLoading(false); });
      } else if (window.fragella) {
        window.fragella.search(searchName).then(data => {
          const url = data?.[0]?.["Image URL Transparent"] || data?.[0]?.["Image URL"] || null;
          if (url) { imgCache[key] = url; setImgUrl(url); }
          else setError(true);
          setLoading(false);
        ...
        // Widget henüz yüklenmediyse bekle
        setTimeout(tryFragella, 500);
      }
    };

    // Önce direkt API dene, olmadı mı widget dene
    fetch(`https://api.fragella.com/api/v1/fragrances?search=${encodeURIComponent(searchName)}&limit=1`, {
      headers: { "x-api-key": FRAGELLA_KEY }
    })
      .then(r => r.json())
      .then(data => {
        if (data?.["Host not in allowlist"] !== undefined || !Array.isArray(data)) {
          tryFragella();
          return;
        }
        const url = data?.[0]?.["Image URL Transparent"] || data?.[0]?.["Image URL"] || null;
  ...
  if (imgUrl) {
    return (
      <div style={{
        width:"90px", height:"130px", flexShrink:0,
  ...
  // Yüklenirken veya hata varsa SVG şişe göster
  ...
  return (
    <svg viewBox="0 0 90 130" xmlns="http://www.w3.org/2000/svg" style={{width:"90px",height:"130px",flexShrink:0, opacity: loading ? 0.5 : 1}}>
      <defs>
        ...
        <linearGradient id={`shine-${id}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="rgba(255,255,255,0.6)"/><stop offset="100%" stopColor="rgba(255,255,255,0.0)"/>
        </linearGradient>
        <linearGradient id={`liquid-${id}`} x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor={c2} stopOpacity="0.9"/><stop offset="100%" stopColor={c3} stopOpacity="0.7"/>
        </linearGradient>
        <filter id={`shadow-${id}`}><feDropShadow dx="2" dy="4" stdDeviation="3" floodOpacity="0.2"/></filter>
        <clipPath id={`clip-${id}`}>
          {isOud ? <path d="M28,40 Q28,35 35,32 L38,22 Q39,18 45,18 Q51,18 52,22 L55,32 Q62,35 62,40 L62,112 Q62,118 56,118 L34,118 Q28,118 28,112 Z"/>
          : isFresh ? <rect x="22" y="30" width="46" height="86" rx="10"/>
      ...
      <g filter={`url(#shadow-${id})`}>
        {isOud ? <path d="M28,40 Q28,35 35,32 L38,22 Q39,18 45,18 Q51,18 52,22 L55,32 Q62,35 62,40 L62,112 Q62,118 56,118 L34,118 Q28,118 28,112 Z" fill={`url(#bg-${id})`} stroke="rgba(255,255,255,0.3)" strokeWidth="0.8"/>
        : isFresh ? <rect x="22" y="30" width="46" height="86" rx="10" fill={`url(#bg-${id})`} stroke="rgba(255,255,255,0.3)" strokeWidth="0.8"/>
        : <path d="M30,45 Q26,40 26,35 L32,28 Q36,24 38,20 L38,16 Q38,14 45,14 Q52,14 52,16 L52,20 Q54,24 58,28 L64,35 Q64,40 60,45 L60,112 Q60,118 52,118 L38,118 Q30,118 30,112 Z" fill={`url(#bg-${id})`} stroke="rgba(255,255,255,0.3)" strokeWidth="0.8"/>}
      </g>
      <g clipPath={`url(#clip-${id})`}>
        <rect x="0" y="50" width="90" height="80" fill={`url(#liquid-${id})`} opacity="0.4"/>
        <path d="M15,58 Q30,52 45,58 Q60,64 75,58 L75,130 L15,130 Z" fill={c2} opacity="0.25"/>
      </g>
      <g clipPath={`url(#clip-${id})`}>
        <ellipse cx="36" cy="65" rx="7" ry="30" fill={`url(#shine-${id})`} opacity="0.7"/>
        <ellipse cx="32" cy="45" rx="4" ry="8" fill="rgba(255,255,255,0.4)"/>
      </g>
      {isOud ? (<><rect x="38" y="6" width="14" height="14" rx="3" fill={c3}/><rect x="42" y="2" width="6" height="6" rx="2" fill={c3}/></>)
      : isFresh ? (<><rect x="30" y="14" width="30" height="18" rx="4" fill={c3}/><rect x="38" y="8" width="14" height="8" rx="3" fill={c3}/><rect x="42" y="4" width="6" height="5" rx="1.5" fill={c3}/></>)
      : (<><rect x="36" y="6" width="18" height="10" rx="3" fill={c3}/><rect x="40" y="2" width="10" height="6" rx="2" fill={c3}/></>)}
      <g clipPath={`url(#clip-${id})`}>
        <rect x={isOud?33:isFloral?31:31} y="68" width={isOud?24:isFloral?28:28} height={isOud?28:22} rx="2" fill="rgba(255,255,255,0.88)" stroke="rgba(255,255,255,0.5)" strokeWidth="0.5"/>
        <text x="45" y="80" textAnchor="middle" fontSize="4.5" fontWeight="800" fontFamily="serif" fill={c3} letterSpacing="0.5">{perfume.brand?.toUpperCase().slice(0,8)}</text>
        <line x1={isOud?36:34} y1="83" x2={isOud?54:56} y2="83" stroke={c2} strokeWidth="0.6" opacity="0.7"/>
        <text x="45" y="89" textAnchor="middle" fontSize="3.5" fontWeight="600" fontFamily="sans-serif" fill={c3} letterSpacing="0.2">{perfume.name?.slice(0,12)}</text>
      </g>
      <ellipse cx="45" cy="120" rx="20" ry="3" fill={c2} opacity="0.15"/>
      {loading && (
        <circle cx="45" cy="65" r="8" fill="none" stroke={c2} strokeWidth="2" strokeDasharray="20 12">
...
export default function App() {
  ...
  function next() {
    ...
    if (step < total - 1) { setAnimKey(k=>k+1); setStep(s=>s+1); }
      ...
      setStep(-1);
      setTimeout(() => {
        const found = filterPerfumes(ans);
        setResults(found);
        setPage("results");
        setStep(0);
            ...
            <>
              <div className="hero">
                ...
                <div className="hero-stats">
                  <div className="stat"><div className="stat-num">160+</div><div className="stat-lbl">Parfüm</div></div>
                  <div className="stat-sep"/>
                  <div className="stat"><div className="stat-num">40+</div><div className="stat-lbl">Marka</div></div>
                  <div className="stat-sep"/>
